...
GameStates.makeNew = function( game, shared ) {
    ...
    function listener (sprite) {
		...
		if ((card[0][0].animations.frame == 0) && (card[0][1].animations.frame == 1) 
			&& (card[0][2].animations.frame == 2) && (card[1][0].animations.frame == 7) 
			&& (card[1][2].animations.frame == 3) && (card[2][0].animations.frame == 6) 
			&& (card[2][1].animations.frame == 5) && (card[2][2].animations.frame == 4)){
    ...
    return {  // Begin game state functions ----------------------------------------------
        ...
        create: function () {
			...
			goal[3] = game.add.sprite(530, game.world.height-322, 'cards',33);
			goal[4] = game.add.sprite(530+83, game.world.height-322, 'cards',52);
			goal[5] = game.add.sprite(530+83*2, game.world.height-322, 'cards',29);
	
			goal[6] = game.add.sprite(530, game.world.height-240, 'cards',32);
			goal[7] = game.add.sprite(530+83, game.world.height-240, 'cards',31);
			goal[8] = game.add.sprite(530+83*2, game.world.height-240, 'cards',30);
			...
			card[1][0] = game.add.sprite(100, game.world.height-322, 'cards',7);
			card[1][1] = game.add.sprite(100+83, game.world.height-322, 'cards',52);
			card[1][2] = game.add.sprite(100+83*2, game.world.height-322, 'cards',3);
	
			card[2][0] = game.add.sprite(100, game.world.height-240, 'cards',6);
			card[2][1] = game.add.sprite(100+83, game.world.height-240, 'cards',5);
			card[2][2] = game.add.sprite(100+83*2, game.world.height-240, 'cards',4);
